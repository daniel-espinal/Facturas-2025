namespace FacturacionGobierno
{
    partial class prueba
    {
        ...
        private void InitializeComponent()
        {
            ...
            customStringConnectionParameters1.ConnectionString = "xpoprovider=MSSqlServer;data source=localhost;initial catalog=FACTURACION;connect" +
    " timeout=1000;integrated security=true";
            this.sqlDataSource1.ConnectionParameters = customStringConnectionParameters1;
            this.sqlDataSource1.Name = "sqlDataSource1";
            storedProcQuery1.Name = "EEHAviso_Gobierno";
            queryParameter1.Name = "@CONTADOR_FACTURA";
            queryParameter1.Type = typeof(string);
            queryParameter1.ValueInfo = "8877";
            queryParameter2.Name = "@ULTIMO_MES_FACTURA";
            queryParameter2.Type = typeof(string);
            queryParameter2.ValueInfo = "1709";
            queryParameter3.Name = "@CODIGO_AGRUPA";
            queryParameter3.Type = typeof(string);
            queryParameter3.ValueInfo = "0063";
            queryParameter4.Name = "@OBTENER_TODOS";
